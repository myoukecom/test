...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/test/cms/Cms/App/Admin/Tpl/Index/css/css.css"/>
    <script type="text/javascript" src="http://localhost/test/cms/Cms/App/Admin/Tpl/Index/js/js.js"></script>
    <base target='iframe'/>
</head>
<body>
<div class="nav">
    ...
    <div class="r_menu">
        ...
        <a href="http://localhost/test/cms/index.php" target="_blank">前台首页</a>
    </div>
    <!--头部右侧导航-->
</div>
<!--左侧导航-->
    ...
    <div class="left_menu">
        <div>
            ...
            <dl>
                <dt>数据备份</dt>
                <dd>
                    <a  href="<?php echo U('Backup/Backup/set');?>">网站备份</a>
                    <a  href="<?php echo U('Backup/Recovery/index');?>">网站还原</a>
                </dd>
            </dl>
        </div>
    </div>
